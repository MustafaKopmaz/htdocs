...
if(isset($_POST['submit'])){
   ...
   if($select_user->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $message[] = 'Başarıyla kaydedildi, şimdi giriş yapın lütfen!';
      }
   }
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="name" required placeholder="Adınızı girin" maxlength="20"  class="box">
      <input type="email" name="email" required placeholder="Mailinizi girin" maxlength="50"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
